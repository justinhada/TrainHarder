...
@DisplayName("OberkoerperBelastungDto sollte")
class OberkoerperBelastungDtoTest
{
	...
	void test04()
	{
		assertAll(
			() -> assertThrows(NullPointerException.class,
				() -> new OberkoerperBelastungDto(null, CHEST, CORE, BACK, BICEPS, SHOULDER)),
			() -> assertThrows(NullPointerException.class,
				() -> new OberkoerperBelastungDto(TRICEPS, null, CORE, BACK, BICEPS, SHOULDER)),
			() -> assertThrows(NullPointerException.class,
				() -> new OberkoerperBelastungDto(TRICEPS, CHEST, null, BACK, BICEPS, SHOULDER)),
			() -> assertThrows(NullPointerException.class,
				() -> new OberkoerperBelastungDto(TRICEPS, CHEST, CORE, null, BICEPS, SHOULDER)),
			() -> assertThrows(NullPointerException.class,
				() -> new OberkoerperBelastungDto(TRICEPS, CHEST, CORE, BACK, null, SHOULDER)),
			() -> assertThrows(NullPointerException.class,
				() -> new OberkoerperBelastungDto(TRICEPS, CHEST, CORE, BACK, BICEPS, null)),
