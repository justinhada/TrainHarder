...
import de.justinharder.old.domain.services.berechnung.KraftlevelErmittlung;
...
import static de.justinharder.old.setup.Testdaten.PASSWORT;
...
@DisplayName("KraftlevelErmittlung sollte")
class KraftlevelErmittlungTest
{
