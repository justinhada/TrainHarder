...
@DisplayName("KoepermasseDto sollte")
class KoerpermasseDtoTest
{
	...
	void setup()
	{
		sut = new KoerpermasseDto(KOERPERGROESSE, KOERPERGEWICHT, KOERPERFETT_ANTEIL, FETTFREIES_KOERPERGEWICHT,
