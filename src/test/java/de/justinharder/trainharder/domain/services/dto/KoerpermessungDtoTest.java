...
class KoerpermessungDtoSollte
{
	...
	void test04()
	{
		assertAll(
			...
			() -> assertThrows(NullPointerException.class, () -> new KoerpermessungDto(ID, null, KOERPERMASSE_DTO, KALORIENEINNAHME, KALORIENVERBRAUCH)),
			() -> assertThrows(NullPointerException.class, () -> new KoerpermessungDto(ID, DATUM, null, KALORIENEINNAHME, KALORIENVERBRAUCH)),
