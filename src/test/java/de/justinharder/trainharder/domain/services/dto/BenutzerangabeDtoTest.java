...
@DisplayName("BenutzerangabeDto sollte")
class BenutzerangabeDtoTest
{
	...
	void setup()
	{
		sut = new BenutzerangabeDto(GESCHLECHT, ERFAHRUNG, ERNAEHRUNG, SCHLAFQUALITAET, STRESS, DOPING,
	...
	void test04()
	{
		assertAll(
			() -> assertThrows(NullPointerException.class,
				() -> new BenutzerangabeDto(null, ERFAHRUNG, ERNAEHRUNG, SCHLAFQUALITAET, STRESS, DOPING,
					REGENERATIONSFAEHIGKEIT)),
			() -> assertThrows(NullPointerException.class,
				() -> new BenutzerangabeDto(GESCHLECHT, null, ERNAEHRUNG, SCHLAFQUALITAET, STRESS, DOPING,
					REGENERATIONSFAEHIGKEIT)),
			() -> assertThrows(NullPointerException.class,
				() -> new BenutzerangabeDto(GESCHLECHT, ERFAHRUNG, null, SCHLAFQUALITAET, STRESS, DOPING,
					REGENERATIONSFAEHIGKEIT)),
			() -> assertThrows(NullPointerException.class,
				() -> new BenutzerangabeDto(GESCHLECHT, ERFAHRUNG, ERNAEHRUNG, null, STRESS, DOPING,
					REGENERATIONSFAEHIGKEIT)),
			() -> assertThrows(NullPointerException.class,
				() -> new BenutzerangabeDto(GESCHLECHT, ERFAHRUNG, ERNAEHRUNG, SCHLAFQUALITAET, null, DOPING,
					REGENERATIONSFAEHIGKEIT)),
			() -> assertThrows(NullPointerException.class,
				() -> new BenutzerangabeDto(GESCHLECHT, ERFAHRUNG, ERNAEHRUNG, SCHLAFQUALITAET, STRESS, null,
					REGENERATIONSFAEHIGKEIT)),
			() -> assertThrows(NullPointerException.class,
				() -> new BenutzerangabeDto(GESCHLECHT, ERFAHRUNG, ERNAEHRUNG, SCHLAFQUALITAET, STRESS, DOPING, null)),
