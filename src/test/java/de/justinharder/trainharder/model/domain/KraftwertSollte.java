	...
	void test04()
	{
		...
		assertAll(
			() -> assertThrows(NullPointerException.class,
				() -> new Kraftwert(null, GEWICHT, koerpergewicht, DATUM, Wiederholungen.ONE_REP_MAX,
					Testdaten.UEBUNG_WETTKAMPFBANKDRUECKEN, Testdaten.BENUTZER_JUSTIN)),
			() -> assertThrows(NullPointerException.class,
				() -> new Kraftwert(PRIMAERSCHLUESSEL, null, koerpergewicht, DATUM, Wiederholungen.ONE_REP_MAX,
					Testdaten.UEBUNG_WETTKAMPFBANKDRUECKEN, Testdaten.BENUTZER_JUSTIN)),
			() -> assertThrows(NullPointerException.class,
				() -> new Kraftwert(PRIMAERSCHLUESSEL, GEWICHT, null, DATUM, Wiederholungen.ONE_REP_MAX,
					Testdaten.UEBUNG_WETTKAMPFBANKDRUECKEN, Testdaten.BENUTZER_JUSTIN)),
			() -> assertThrows(NullPointerException.class,
				() -> new Kraftwert(PRIMAERSCHLUESSEL, GEWICHT, koerpergewicht, null, Wiederholungen.ONE_REP_MAX,
					Testdaten.UEBUNG_WETTKAMPFBANKDRUECKEN, Testdaten.BENUTZER_JUSTIN)),
			() -> assertThrows(NullPointerException.class,
				() -> new Kraftwert(PRIMAERSCHLUESSEL, GEWICHT, koerpergewicht, DATUM, null,
					Testdaten.UEBUNG_WETTKAMPFBANKDRUECKEN, Testdaten.BENUTZER_JUSTIN)),
			() -> assertThrows(NullPointerException.class,
				() -> new Kraftwert(PRIMAERSCHLUESSEL, GEWICHT, koerpergewicht, DATUM, Wiederholungen.ONE_REP_MAX,
					null, Testdaten.BENUTZER_JUSTIN)),
			() -> assertThrows(NullPointerException.class,
				() -> new Kraftwert(PRIMAERSCHLUESSEL, GEWICHT, koerpergewicht, DATUM, Wiederholungen.ONE_REP_MAX,
					Testdaten.UEBUNG_WETTKAMPFBANKDRUECKEN, null)),
