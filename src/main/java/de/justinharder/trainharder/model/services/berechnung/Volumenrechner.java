...
public class Volumenrechner
{
	...
	{
		return new int[]
			{ mappeZuInt(empfehlungen[0][0]), mappeZuInt(empfehlungen[0][1]),
	...
	{
		return new int[]
			{ mappeZuInt(empfehlungen[1][0]), mappeZuInt(empfehlungen[1][1]),
	...
	{
		return new int[]
			{ mappeZuInt(empfehlungen[2][0]), mappeZuInt(empfehlungen[2][1]),
