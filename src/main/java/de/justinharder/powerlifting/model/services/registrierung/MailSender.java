...
public class MailSender
{
	...
	public boolean sendeRegistrierungMail(final AuthentifizierungEintrag authentifizierungEintrag)
	{
		...
		try
		{
			...
			message.setSubject("Ihre Registrierung bei Powerlifting", StandardCharsets.UTF_8.name());
	...
	{
		final var link = "<a href=\"localhost:8080/Powerlifting/create.xhtml?id=" + authentifizierungEintrag.getId()
			+ "\">Bestätige E-Mail-Adresse und erstelle Benutzer</a>";

		return new StringBuilder("Hallo " + authentifizierungEintrag.getBenutzername() + ",\n")
			.append("deine Registrierung bei Powerlifting war erfolgreich! ")
